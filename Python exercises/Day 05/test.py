...
def asking_to_guess():
    ...
    while tries>0 and '-'in revealed_letters:
        ...
        if guessed_letter in guessed_letters: #check to see if the newly guessed letter is already guessed previously
            ...
            guessed_letters.append(guessed_letter) #if the new letter is not previously guesed,appened the
        ...
        print (''.join(result))#join the strings together without spaces between letters
asking_to_guess()
